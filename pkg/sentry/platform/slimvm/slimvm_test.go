...
// testSandboxID is an arbitrary fixed sandbox ID for tests. The slimvm host
// kernel module uses this value to bucket per-sandbox state.
const testSandboxID = "deadbeef"
...
func slimvmTest(t testHarness, setup func(*SlimVM), fn func(*vCPU) bool) {
	...
	k, err := New(deviceFile, testSandboxID)
	if err != nil {
...
func bluepillTest(t testHarness, fn func(*vCPU)) {
	slimvmTest(t, nil, func(c *vCPU) bool {
		bluepill(c)
		fn(c)
		return false
	})
